...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    title: "Поиск поставщиков для тендеров: 44-ФЗ и 223-ФЗ | TenderLex",
    description:
      "Быстрый поиск надежных поставщиков под тендеры 44-ФЗ, 223-ФЗ и коммерческие закупки: прямые контакты дилеров и расчет себестоимости заявки.",
    siteName: "TenderLex",
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "TenderLex — Поиск поставщиков для тендеров",
      },
    ],
  },
  twitter: {
