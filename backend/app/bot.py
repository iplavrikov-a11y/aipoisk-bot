...
async def help_button(message: Message) -> None:
    text = (
        ...
        "1️⃣ Шаг 1: «📄 Анализ закупки» — аудит рисков, сроков, штрафов и нацрежима ПП 616/617/878 перед участием.\n"
        "2️⃣ Шаг 2: «🎯 Подбор товара и аналогов» — расшифровка модели под ТЗ, подготовка Формы 2 для заявки и 2–4 эквивалента РФ.\n"
        "3️⃣ Шаг 3: «🔎 Поставщики по ТЗ» — поиск прямых заводов РФ и дилеров с контактами/email для запроса КП.\n"
        ...
        "• Для подбора и поставщиков: файл ТЗ (.pdf, .docx, .xlsx, .zip) или текст спецификации.\n\n"
