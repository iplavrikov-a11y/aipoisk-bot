...
def detect_minprom_registry_requirement(report_text: str) -> Optional[bool]:
    """
    Детерминированное определение требования реестра Минпромторга из ТЗ или отчёта анализа.
    ...
    # Прямые триггеры из ТЗ и законов (ПП 616, 878, 617, 1875, реестр ГИСП)
    minprom_triggers = (
        ...
        "пп 616",
        "постановление № 878",
        "постановление правительства № 878",
        "пп рф 878",
        "пп 878",
        "национальный режим",
        "нацрежим",
    ...
    if any(trig in t_low for trig in minprom_triggers):
        return True
